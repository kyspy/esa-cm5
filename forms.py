...
class TrackingForm(Form):
    ...
    laborer = IntegerField('Laborer:', validators = [Required()])
    foreman = IntegerField('Foreman:', validators = [Required()])
    supervisor = IntegerField('Supervisor:', validators = [Required()])
